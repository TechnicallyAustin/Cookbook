...
import {Divider,Pagination, PaginationItem, PaginationColor, Card, CardBody, CardFooter, Image} from '@nextui-org/react'
    ...
    return (
      <section id="snacks" className="w-full h-full flex flex-col gap-2 p-1">
        ...
        <section className='w-full h-16 flex justify-center md:absolute md:bottom-0 md:translate-y-12 items-center pt-6'>
            <Pagination  showShadow showControls="true" size="md" variant="shadow" color="primary" total={10} initialPage={1} className="" />
        </section>
